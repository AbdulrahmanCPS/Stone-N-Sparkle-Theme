 ...
 * Uses DOMContentLoaded and event delegation so buttons work reliably.
 */
(function () {
    'use strict';
    ...
    function run() {
        ...
        // Event delegation: one listener on document so "Add image" works even if DOM is re-rendered or script ran early
        document.addEventListener('click', function (ev) {
            var btn = ev.target.closest('.ss-collection-lookbook-add');
            if (!btn) return;
            ev.preventDefault();
            ev.stopPropagation();
